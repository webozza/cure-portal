                ...
                <table>
                  <tr>
                    ...
                    <td class="link-to-brief">
                      <a href="" style="background-color: #ffd54f"
                        >Billboard Banner</a
                      >
                    </td>
                  ...
                  <tr>
                    ...
                    <td class="link-to-brief">
                      <a
                        href="/uploads/Vyro_Digital Advertising Brief_Initial setup.pdf"
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="actions">
                        <a
                          target="_blank"
                          href="approvals/Vyro - Google Ads Action Plan.pdf"
                        >
                          <i title="view" class="flaticon-eye"></i>
                        </a>
                        <a
                          class="cc--approval-comment"
                          href="javascript:void(0)"
                          ><i title="message" class="flaticon-chat"></i
                        ></a>
                        <input
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="actions">
                        <a
                          target="_blank"
                          href="approvals/Vyro - Google Ads Audit.pdf"
                        >
                          <i title="view" class="flaticon-eye"></i>
                        </a>
                        <a
